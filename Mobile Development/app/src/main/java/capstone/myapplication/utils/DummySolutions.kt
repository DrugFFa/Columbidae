    ...
    fun generateDummmySolutions():ArrayList<Entity>{
        ...
        solutions.add(
            Entity(
                1,
                "CROWNED PIGEON",
                "Nama Latin : Goura sclaterii \\n\n" +
                        "Habitat Asli : Papua & Papua Nugini (Irian) \\n\n" +
                        "Informasi Singkat :  In 1819 the English scientist James Francis Stephens established the genus.\n" +
